...
# Define the upper and lower bounds for a particular color(brush) to be detected
lower_bound = np.array([101, 101, 101])
upper_bound = np.array([121, 255, 255])    # blue

# Define a 5x5 kernel for erosion and dilation
kernel = np.ones((5, 5), np.uint8)

# Setup deques to store separate colors in separate arrays (Blue, Green, Red, Yellow points)
